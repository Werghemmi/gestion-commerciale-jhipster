...
/**
 * REST controller for managing {@link com.werghemmi.gc.domain.Categorie}.
 */
@RestController
@RequestMapping("/api")
public class CategorieResource {
    ...
    public ResponseEntity<List<CategorieDTO>> getAllCategories(Pageable pageable, @RequestParam(required = false, defaultValue = "false") boolean eagerload) {
        log.debug("REST request to get a page of Categories");
        Page<CategorieDTO> page;
        if (eagerload) {
