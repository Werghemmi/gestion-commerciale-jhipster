...
public class CategorieServiceImpl implements CategorieService {
    ...
    public Page<CategorieDTO> findAllWithEagerRelationships(Pageable pageable) {
        return categorieRepository.findAllWithEagerRelationships(pageable).map(categorieMapper::toDto);
    }
