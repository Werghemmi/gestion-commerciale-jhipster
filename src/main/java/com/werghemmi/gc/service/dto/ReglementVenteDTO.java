...
/**
 * A DTO for the {@link com.werghemmi.gc.domain.ReglementVente} entity.
 */
public class ReglementVenteDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ReglementVenteDTO)) {
            return false;
        }

        return id != null && id.equals(((ReglementVenteDTO) o).id);
    }
