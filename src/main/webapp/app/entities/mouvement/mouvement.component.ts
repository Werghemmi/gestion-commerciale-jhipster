...
export class MouvementComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.mouvementService
      ...
      .subscribe(
        (res: HttpResponse<IMouvement[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInMouvements(): void {
    this.eventSubscriber = this.eventManager.subscribe('mouvementListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IMouvement[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
