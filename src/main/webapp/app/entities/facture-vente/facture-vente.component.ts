...
export class FactureVenteComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.factureVenteService
      ...
      .subscribe(
        (res: HttpResponse<IFactureVente[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInFactureVentes(): void {
    this.eventSubscriber = this.eventManager.subscribe('factureVenteListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IFactureVente[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
